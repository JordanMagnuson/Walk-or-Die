package game 
{
	...
	public class Location extends Entity
	{
		...
		public function Location(DAY_SOUND:Class, NIGHT_SOUND:Class, maxCreationTime:Number = 4, minCreationTime:Number = 0.5, creationTimeIncreaseRate:Number = 0.4, creationTimeDecreaseRate:Number = 0.4) 
		{
			...
			this.maxCreationTime = (maxCreationTime / (Player.SPEED / 100));
			this.minCreationTime = (minCreationTime / (Player.SPEED / 100));
			this.creationTimeIncreaseRate = (creationTimeIncreaseRate * (Player.SPEED / 100));
			this.creationTimeDecreaseRate = (creationTimeDecreaseRate * (Player.SPEED / 100));
